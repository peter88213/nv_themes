...
For creating a message catalog, you download a template with all English messages from [here](https://github.com/peter88213/nv_themes/blob/main/i18n/messages.pot). 
...
Name the binary file **nv_themes.mo**. 


### Install your translation for testing

Add a subdirectory tree to **~/.novx/locale**, and place *nv_themes.mo* there, like this:
...
**HINT:** *nv_themes* comes with German translations. Look at the `de` directory tree, if you need an example. 
...
*nv_themes* depends on the [novxlib](https://github.com/peter88213/novxlib) and [themesnv](https://github.com/peter88213/themesnv) libraries which must be present in your file system. It is organized as an Eclipse PyDev project. The official release branch on GitHub is *main*.
