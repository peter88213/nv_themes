[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_themes/raw/main/dist/nv_themes_v5.0.2.pyz)
...
Download the latest release [nv_themes_v5.0.2.pyz](https://github.com/peter88213/nv_themes/raw/main/dist/nv_themes_v5.0.2.pyz)

- Launch *nv_themes_v5.0.2.pyz* by double-clicking (Windows/Linux desktop),
- or execute `python nv_themes_v5.0.2.pyz` (Windows), resp. `python3 nv_themes_v5.0.2.pyz` (Linux) on the command line.
