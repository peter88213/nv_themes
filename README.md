[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_themes/raw/main/dist/nv_themes_v5.0.0.pyzw)
...
Download the latest release [nv_themes_v5.0.0.pyzw](https://github.com/peter88213/nv_themes/raw/main/dist/nv_themes_v5.0.0.pyzw)

- Launch *nv_themes_v5.0.0.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python nv_themes_v5.0.0.pyzw` (Windows), resp. `python3 nv_themes_v5.0.0.pyzw` (Linux) on the command line.
...
The package is also available in zip format: [nv_themes_v5.0.0.zip](https://github.com/peter88213/nv_themes/raw/main/dist/nv_themes_v5.0.0.zip)

- Extract the *nv_themes_v5.0.0* folder from the downloaded zipfile "nv_themes_v5.0.0.zip".
