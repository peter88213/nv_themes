[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_themes/raw/main/dist/nv_themes_v5.0.9.pyz)
...
Download the latest release [nv_themes_v5.0.9.pyz](https://github.com/peter88213/nv_themes/raw/main/dist/nv_themes_v5.0.9.pyz) (15 KB)

- Launch *nv_themes_v5.0.9.pyz* by double-clicking (Windows desktop),
- or execute `python nv_themes_v5.0.9.pyz` (Windows), resp. `python3 nv_themes_v5.0.9.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_themes_v5.0.9.zip](https://github.com/peter88213/nv_themes/raw/main/dist/nv_themes_v5.0.9.zip) (15 KB)

- Extract the *nv_themes_v5.0.9* folder from the downloaded zipfile "nv_themes_v5.0.9.zip".
